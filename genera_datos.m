...
CSR = 30;                       % relación clutter a señal
SNR = 10;                       % relación señal a ruido

Sp = 10^(50/10);                         % potencia del fenomeno (mantener en 1)
vm = 0.3*vs;                   % velocidad media del fenomeno [m/s]
sigma_pv = 2;                   % ancho espectral del fenomeno [m/s]

fm = -2*vm/lambda;              % frecuencia media del fenomeno [Hz]
